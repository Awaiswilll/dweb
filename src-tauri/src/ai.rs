...
pub fn default_models_for_provider(provider: &str) -> Vec<ModelInfo> {
    match provider {
        "ollama" => vec![
            ModelInfo { id: "qwen2.5-coder:7b".into(), name: "Qwen 2.5 Coder 7B".into(), provider: "ollama".into(), description: "🔋 Balanced — best local code model".into() },
            ModelInfo { id: "qwen2.5-coder:1.5b".into(), name: "Qwen 2.5 Coder 1.5B".into(), provider: "ollama".into(), description: "⚡ Fast — lightweight code model".into() },
            ModelInfo { id: "codellama:7b".into(), name: "Code Llama 7B".into(), provider: "ollama".into(), description: "🔋 Balanced — Meta's code model".into() },
            ModelInfo { id: "deepseek-coder:6.7b".into(), name: "DeepSeek Coder 6.7B".into(), provider: "ollama".into(), description: "🔋 Balanced — strong code".into() },
            ModelInfo { id: "mistral:7b".into(), name: "Mistral 7B".into(), provider: "ollama".into(), description: "🔋 Balanced — general purpose".into() },
            ModelInfo { id: "phi3:mini".into(), name: "Phi-3 Mini 3.8B".into(), provider: "ollama".into(), description: "⚡ Fast — small but capable".into() },
            ModelInfo { id: "llama3.2:3b".into(), name: "Llama 3.2 3B".into(), provider: "ollama".into(), description: "⚡ Fast — latest Meta small model".into() },
        ],
        "openai" => vec![
            ModelInfo { id: "gpt-4o".into(), name: "GPT-4o".into(), provider: "openai".into(), description: "🚀 Powerful — flagship model".into() },
            ModelInfo { id: "gpt-4o-mini".into(), name: "GPT-4o Mini".into(), provider: "openai".into(), description: "⚡ Fast — cheaper, capable".into() },
            ModelInfo { id: "gpt-4-turbo".into(), name: "GPT-4 Turbo".into(), provider: "openai".into(), description: "🚀 Powerful — previous gen".into() },
            ModelInfo { id: "gpt-3.5-turbo".into(), name: "GPT-3.5 Turbo".into(), provider: "openai".into(), description: "⚡ Fast — economical".into() },
            ModelInfo { id: "o3-mini".into(), name: "o3-mini".into(), provider: "openai".into(), description: "⚡ Fast — reasoning, low cost".into() },
        ],
        "anthropic" => vec![
            ModelInfo { id: "claude-sonnet-4-20250514".into(), name: "Claude Sonnet 4".into(), provider: "anthropic".into(), description: "🚀 Powerful — latest balanced".into() },
            ModelInfo { id: "claude-3-5-sonnet-latest".into(), name: "Claude 3.5 Sonnet".into(), provider: "anthropic".into(), description: "🚀 Powerful — previous gen".into() },
            ModelInfo { id: "claude-3-opus-latest".into(), name: "Claude 3 Opus".into(), provider: "anthropic".into(), description: "🚀 Powerful — most capable".into() },
            ModelInfo { id: "claude-3-haiku-latest".into(), name: "Claude 3 Haiku".into(), provider: "anthropic".into(), description: "⚡ Fast — fastest Claude".into() },
        ],
        "google" => vec![
            ModelInfo { id: "gemini-2.0-flash".into(), name: "Gemini 2.0 Flash".into(), provider: "google".into(), description: "⚡ Fast — efficient".into() },
            ModelInfo { id: "gemini-1.5-pro".into(), name: "Gemini 1.5 Pro".into(), provider: "google".into(), description: "🚀 Powerful — most capable".into() },
            ModelInfo { id: "gemini-1.5-flash".into(), name: "Gemini 1.5 Flash".into(), provider: "google".into(), description: "⚡ Fast — cost-effective".into() },
        ],
        "together" => vec![
            ModelInfo { id: "Qwen/Qwen2.5-Coder-32B-Instruct".into(), name: "Qwen 2.5 Coder 32B".into(), provider: "together".into(), description: "🚀 Powerful — top-tier code".into() },
            ModelInfo { id: "meta-llama/Llama-3.3-70B-Instruct-Turbo".into(), name: "Llama 3.3 70B".into(), provider: "together".into(), description: "🚀 Powerful — Meta large".into() },
            ModelInfo { id: "mistralai/Mixtral-8x22B-Instruct-v0.1".into(), name: "Mixtral 8x22B".into(), provider: "together".into(), description: "🚀 Powerful — Mistral MoE".into() },
            ModelInfo { id: "codellama/CodeLlama-34b-Instruct-hf".into(), name: "Code Llama 34B".into(), provider: "together".into(), description: "🚀 Powerful — code spec".into() },
        ],
        "groq" => vec![
            ModelInfo { id: "llama-3.3-70b-versatile".into(), name: "Llama 3.3 70B".into(), provider: "groq".into(), description: "🚀 Powerful — fast on Groq".into() },
            ModelInfo { id: "llama-3.1-8b-instant".into(), name: "Llama 3.1 8B".into(), provider: "groq".into(), description: "⚡ Fast — lightning fast".into() },
            ModelInfo { id: "mixtral-8x7b-32768".into(), name: "Mixtral 8x7B".into(), provider: "groq".into(), description: "🚀 Powerful — large ctx".into() },
            ModelInfo { id: "gemma2-9b-it".into(), name: "Gemma 2 9B".into(), provider: "groq".into(), description: "🔋 Balanced — Google efficient".into() },
        ],
        "openrouter" => vec![
            ModelInfo { id: "openai/gpt-4o".into(), name: "OpenAI GPT-4o".into(), provider: "openrouter".into(), description: "🚀 Powerful — via OpenRouter".into() },
            ModelInfo { id: "anthropic/claude-3.5-sonnet".into(), name: "Claude 3.5 Sonnet".into(), provider: "openrouter".into(), description: "🚀 Powerful — via OpenRouter".into() },
            ModelInfo { id: "google/gemini-2.0-flash-001".into(), name: "Gemini 2.0 Flash".into(), provider: "openrouter".into(), description: "⚡ Fast — via OpenRouter".into() },
            ModelInfo { id: "meta-llama/llama-3.3-70b-instruct".into(), name: "Llama 3.3 70B".into(), provider: "openrouter".into(), description: "🚀 Powerful — via OpenRouter".into() },
            ModelInfo { id: "qwen/qwen-2.5-coder-32b-instruct".into(), name: "Qwen 2.5 Coder 32B".into(), provider: "openrouter".into(), description: "🚀 Powerful — via OpenRouter".into() },
        ],
        _ => vec![],
    }
}
...
pub async fn update_provider(config: ProviderConfig) {
    ...
    if let Some(existing) = providers.iter_mut().find(|p| p.provider_type == config.provider_type) {
        *existing = config;
    } else {
...
pub async fn get_provider(provider_type: &str) -> Option<ProviderConfig> {
    ...
    providers.iter().find(|p| p.provider_type == provider_type).cloned()
}
...
pub async fn ai_generate(
    ...
    let config = {
        let providers = PROVIDERS.lock().await;
        providers.iter().find(|p| p.provider_type == provider_type)
            .ok_or_else(|| format!("Provider '{}' not configured", provider_type))?
            .clone()
    };

    if !config.enabled {
        return Err(format!("Provider '{}' is disabled. Enable it in Settings.", config.label));
    }

    let model = if model.is_empty() {
        config.default_model.clone().unwrap_or_else(|| "unknown".into())
    } else {
        model
    };
...
async fn ollama_generate(
    ...
    let result: serde_json::Value = resp.json().await.map_err(|e| format!("Ollama parse error: {}", e))?;
...
async fn ollama_generate_stream(
    ...
    while let Some(chunk_result) = stream.next().await {
        ...
        while let Some(line_end) = buffer.find('\n') {
            ...
            if data == "[DONE]" {
                let _ = app.emit("ai:token", StreamToken { token: String::new(), done: true });
                return Ok(());
            }
        ...
        for m in arr {
            if let Some(name) = m["name"].as_str() {
                models.push(ModelInfo {
                    ...
                    name: name.to_string(),
                    provider: "ollama".into(),
                    description: format!("{}B params", m["details"]["parameter_size"].as_str().unwrap_or("?")),
                });
            }
        }
    }
...
async fn openai_chat_generate(
    ...
    let api_key = cfg.api_key.as_deref().ok_or("API key not set for this provider")?;
    ...
    if !status.is_success() {
        let err_msg = result["error"]["message"].as_str().unwrap_or("Unknown API error");
    ...
    let tokens_out = result["usage"]["completion_tokens"].as_u64().map(|v| v as u32);
    ...
    if let Some(arr) = result["data"].as_array() {
        for m in arr.iter().take(50) {
            if let Some(id) = m["id"].as_str() {
                ...
                if id.contains("gpt") || id.contains("o1") || id.contains("o3") || id.contains("claude") || id.contains("llama") || id.contains("mixtral") || id.contains("gemma") || id.contains("qwen") || id.contains("mistral") {
                    models.push(ModelInfo {
                        id: id.to_string(),
                        name: id.to_string(),
                        provider: cfg.provider_type.clone(),
...
async fn anthropic_generate(
    ...
    let base_url = cfg.base_url.as_deref().unwrap_or("https://api.anthropic.com/v1");
    let api_key = cfg.api_key.as_deref().ok_or("API key not set for Anthropic")?;
...
async fn google_generate(
    ...
    let base_url = cfg.base_url.as_deref().unwrap_or("https://generativelanguage.googleapis.com/v1beta");
    let api_key = cfg.api_key.as_deref().ok_or("API key not set for Google Gemini")?;
    ...
    let content = result["candidates"][0]["content"]["parts"][0]["text"].as_str().unwrap_or("").to_string();
...
async fn fetch_models_from_api(provider_type: &str) -> Result<Vec<ModelInfo>, String> {
    let providers = PROVIDERS.lock().await;
    let cfg = providers.iter().find(|p| p.provider_type == provider_type)
...
#[tauri::command]
pub async fn ai_build(prompt: String, provider_type: String, model: String) -> Result<String, String> {
    let config = {
        let providers = PROVIDERS.lock().await;
        providers.iter().find(|p| p.provider_type == provider_type)
            .ok_or_else(|| format!("Provider '{}' not configured", provider_type))?
...
pub async fn test_ai_connection(provider_type: String) -> Result<String, String> {
    let providers = PROVIDERS.lock().await;
    let config = providers.iter().find(|p| p.provider_type == provider_type)
        .ok_or_else(|| format!("Provider '{}' not configured", provider_type))?
        .clone();
    drop(providers);
    ...
    match provider_type.as_str() {
        ...
        "anthropic" => {
            ...
            if resp.status().is_success() || resp.status().as_u16() == 400 {
                ...
                Err(format!("Auth failed ({}): check your API key", resp.status()))
            }
        }
        "google" => {
            let api_key = config.api_key.as_deref().ok_or("API key is required")?;
